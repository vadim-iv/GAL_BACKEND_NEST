...
export declare class DecisionController {
    ...
    updateStatus(id: string, dto: UpdateStatusDto): Promise<import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("../schemas/decision.schema").Decision, {}> & import("../schemas/decision.schema").Decision & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }, {}> & import("mongoose").Document<unknown, {}, import("../schemas/decision.schema").Decision, {}> & import("../schemas/decision.schema").Decision & {
